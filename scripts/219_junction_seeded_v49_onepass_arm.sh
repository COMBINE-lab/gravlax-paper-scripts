...
# Archived from the analysis host as scripts/153b_v49_onepass_arm.sh (2026-09-11); renumbered here to follow the repository sequence.
set -euo pipefail
...
echo "[$(date)] align v49 one-pass"; align v49-1pass $O/v49.sjdb.tab no; ingest v49-1pass $O/v49.sjdb.tab frozen-catalogue $O/v49.sjdb.tab
for arm in v49-1pass; do
  A=$O/d0-$arm.aie
